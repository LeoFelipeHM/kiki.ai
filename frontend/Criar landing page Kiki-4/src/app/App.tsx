import { Sparkles, Calendar, MessageCircle, FileText, Shield, Zap, Menu, X, ArrowRight, Star, Brain, Clock, Search, CalendarCheck, ListTodo, ClipboardList, AlarmClock, Check, Users, Target } from 'lucide-react';
...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex items-center gap-3">
              <button onClick={() => navigateTo('signup')} className="px-4 py-2 text-sm text-gray-700 hover:text-gray-900 rounded-lg hover:bg-gray-50 transition-colors">
                Entrar
              </button>
            ...
            <nav className="md:hidden py-4 border-t border-gray-100">
              <div className="flex flex-col gap-1">
                ...
                <div className="mt-4 px-4 flex flex-col gap-2">
                  <button onClick={() => navigateTo('signup')} className="px-5 py-2.5 text-sm text-center text-gray-700 border border-gray-200 rounded-full hover:bg-gray-50">
                    Entrar
                  </button>
      ...
      {currentPage === 'how' && <HowItWorksPage navigateTo={navigateTo} />}
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8 mb-6 md:mb-8">
            <div className="col-span-2 md:col-span-1">
              <button onClick={() => navigateTo('home')} className="flex items-center gap-2 md:gap-3 mb-3 md:mb-4 hover:opacity-80 transition-opacity">
                <div className="w-7 h-7 md:w-8 md:h-8 rounded-lg bg-gradient-to-br from-purple-500 to-pink-500 flex items-center justify-center">
...
function HomePage({ navigateTo }: { navigateTo: (page: Page) => void }) {
  return (
    <>
      ...
      {/* CTA Section */}
      <section className="py-12 md:py-20 px-4 md:px-6 bg-gradient-to-br from-purple-600 via-pink-600 to-purple-700">
  ...
  return (
    <section className="pt-24 md:pt-32 pb-12 md:pb-20 px-4 md:px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-12 lg:gap-16 items-center mb-10 md:mb-16">
          <div>
    ...
    <section className="pt-24 md:pt-32 pb-12 md:pb-20 px-4 md:px-6">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-4 md:gap-8 max-w-5xl mx-auto mb-10 md:mb-16">
          <div className="border border-gray-200 rounded-2xl md:rounded-3xl p-6 md:p-8 hover:border-gray-300 transition-all">
          ...
          <div className="border-2 border-purple-600 rounded-2xl md:rounded-3xl p-6 md:p-8 relative shadow-lg">
...
// Signup Page
function SignupPage({ navigateTo }: { navigateTo: (page: Page) => void }) {
  return (
    <section className="pt-24 md:pt-32 pb-12 md:pb-20 px-4 md:px-6 bg-gray-50 min-h-screen">
